...
const QMetaObject facedetect::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_facedetect.data,
      qt_meta_data_facedetect,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *facedetect::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_facedetect.stringdata0))
        return static_cast<void*>(const_cast< facedetect*>(this));
